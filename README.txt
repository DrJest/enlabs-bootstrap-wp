EnlightenedLabs Bootstrap WP WordPress theme is licensed under the GPL.
...
Enlightened Labs Bootstrap WP Theme bundles the following third-party resources:

Bootstrap Canvas WP WordPress theme, Copyright 2014 Schon Garcia
Bootstrap Canvas WP WordPress theme is licensed under the GPL.
Source: https://wordpress.org/themes/bootstrap-canvas-wp

Bootstrap, Copyright (c) 2013 Twitter, Inc.
...
wp-bootstrap-navwalker, Copyright (c) 2014 Edward McIntyre
wp-bootstrap-navwalker.php is licensed under GPL2
